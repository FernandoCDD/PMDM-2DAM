...
class PokemonDetailResponse {
  ...
  factory PokemonDetailResponse.fromMap(Map<String, dynamic> data) {
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [PokemonDetailResponse].
  factory PokemonDetailResponse.fromJson(String data) {
    return PokemonDetailResponse.fromMap(
        json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [PokemonDetailResponse] to a JSON string.
