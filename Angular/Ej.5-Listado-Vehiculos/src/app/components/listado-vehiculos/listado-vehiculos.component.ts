...
import { Vehiculos } from 'src/app/models/starWars-interface';
...
function getFoto (){
  ...
  VEHICULOS.forEach(element => {
      ...
      var cogerId = arrayId.pop();
      var idSinBarra = cogerId?.substring(0, -1);

      return "./assets/img/vehicles/"+idSinBarra+".jpg";
  });
}
